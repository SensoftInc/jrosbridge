...
public class Ros {
        ...
        try {
            ...
            webSocketClient = new WebSocketClient(uri, new Draft_6455(), null, timeout) {
                ...
                public void onOpen(ServerHandshake serverHandshake) {
                    connected = true;
                    connectionCallback.onOpen(serverHandshake);
                }

                @Override
                public void onMessage(String s) {
                    Ros.this.onMessage(s);
                }

                @Override
                public void onClose(int i, String s, boolean b) {
                    connected = false;
                    connectionCallback.onClose(i, s, b);
                }
    ...
    public boolean isConnected() {
        return webSocketClient != null && connected;
    }
    ...
    public void onMessage(String message) {
        try {
            ...
            if (op.equals(JRosbridge.OP_CODE_PNG)) {
                //TODO
                System.out.println("TODO received PNG NEED FIXXXX");
                /*
